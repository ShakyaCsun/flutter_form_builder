...
class FormBuilderColoredChoiceChip<T> extends FormBuilderField<T> {
  /// The list of items the user can select.
  final List<FormBuilderNewFieldOption<T>> options;
          ...
          builder: (FormFieldState<T?> field) {
            ...
            return InputDecorator(
              ...
              child: Wrap(
                ...
                children: <Widget>[
                  for (FormBuilderNewFieldOption<T> option in options)
                    ChoiceChip(
                      label: option,
...
class _FormBuilderChoiceChipState<T>
    extends FormBuilderFieldState<FormBuilderColoredChoiceChip<T>, T> {}

/// An option for fields with selection options.
///
/// The type `T` is the type of the value the entry represents. All the entries
/// in a given menu must represent values with consistent types.
class FormBuilderNewFieldOption<T> extends StatelessWidget {
  final Widget? child;
  final T value;
  ...
  const FormBuilderNewFieldOption({
    Key? key,
    required this.value,
    this.child,
